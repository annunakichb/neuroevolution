...
datapath = files.get_data_path() + os.sep + 'evolvability' + os.sep + 'experimentD' + os.sep
...
if __name__ == '__main__':
    ...
    run(mode='noreset', maxepochcount=50, complexunit=25.)
    run(mode='noreset', maxepochcount=50, complexunit=50.)
    run(mode='noreset', maxepochcount=50, complexunit=70.)
    run(mode='noreset', maxepochcount=50, complexunit=100.)
